      ...
      <div className="w-full md:w-64 p-5 flex flex-col gap-5 border-b md:border-b-0 md:border-r border-border bg-card">
          ...
          >
            ...
            <Popover className="min-w-[var(--trigger-width)] bg-popover border border-border rounded-md shadow-lg p-1 z-50">
              <ListBox className="outline-none">
                <ListBoxItem
                  id="Custom"
                  textValue="Пользовательский"
                  className="px-2 py-1.5 text-sm rounded cursor-pointer hover:bg-accent hover:text-accent-foreground outline-none text-popover-foreground"
                >
                  Пользовательский
                </ListBoxItem>
                <ListBoxItem
                  id="Last 7 Days"
                  textValue="Последние 7 дней"
                  className="px-2 py-1.5 text-sm rounded cursor-pointer hover:bg-accent hover:text-accent-foreground outline-none text-popover-foreground"
                >
                  Последние 7 дней
                </ListBoxItem>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <div
              id="start-date-label"
              className="h-full flex items-center justify-center w-[80px] px-4 bg-primary text-primary-foreground"
            >
