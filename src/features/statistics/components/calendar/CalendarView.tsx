...
import { today, getLocalTimeZone, isWeekend, isSameDay } from '@internationalized/date';
...
export const CalendarView = React.memo(({ range, onRangeChange }: CalendarViewProps) => {
  return (
    <div className="flex-1 p-6 bg-card flex justify-center">
      <div className="w-full max-w-[280px] sm:max-w-[320px]">
        ...
        >
          <header className="flex items-center justify-between w-full mb-6">
            ...
            <Heading className="text-lg font-bold text-foreground text-center flex-1" />
            <Button
              slot="next"
              className="p-1 text-muted-foreground hover:text-foreground transition-colors outline-none rounded-full hover:bg-accent"
            >
          ...
          <CalendarGrid className="border-collapse">
            ...
            <CalendarGridBody>
              {(date) => (
                <CalendarCell
                  date={date}
                  className="w-10 h-10 p-0 relative outline-none cursor-default group"
                >
                        ...
                        <div
                          className={cn(
                            ...
                            isToday &&
                              ...
                              !isStart &&
                              !isEnd &&
                              'ring-2 ring-accent ring-offset-2 ring-offset-primary/20',
