        ...
        {(segment) => (
          <DateSegment
            ...
            className={twJoin(
              ...
              "focus:bg-primary/20 focus:text-foreground focus:data-invalid:bg-destructive/20 focus:data-invalid:text-destructive-foreground forced-colors:focus:bg-[Highlight] forced-colors:focus:text-[HighlightText]",
