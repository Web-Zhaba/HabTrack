...
const LogInPage = lazy(() => import("src/features/auth/pages/LogIn.tsx"));
const RegisterPage = lazy(() => import("src/features/auth/pages/Register.tsx"));
const ResetPasswordPage = lazy(() => import("src/features/auth/pages/ResetPassword.tsx"));
