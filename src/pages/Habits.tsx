...
import { EmptyHabits } from "src/features/habits/components/EmptyHabits"
import { HabitCreateModal } from "src/features/habits/components/HabitCreateModal"
import { HabitCard } from "src/features/habits/components/HabitCard"
import type { Habit } from "src/features/habits/types/habit.types"
import { addHabit, removeHabit, updateHabit } from "src/features/habits/store/habitsSlice"
import { upsertManyHabitLogs } from "src/features/statistics/store/habitLogsSlice"
      ...
      >
        <div className="flex flex-col gap-4">
          <p className="text-muted-foreground text-sm">
            Вы уверены, что хотите удалить эту привычку? Это действие нельзя будет отменить,
            и вся история выполнения будет потеряна.
          </p>
